...
# /home/dylanrpenn/.conda/envs/punch/bin/python scheduler_testbed/training_scripts/run_tune_script.py $1
srun --cpus-per-task=128 /home/dylanrpenn/.conda/envs/punch/bin/python scheduler_testbed/training_scripts/run_tune_script.py $1

# To run file:
#   1. Make sure your working directory is the repo
#   2. Enter the following into bash terminal: sbatch scheduler_testbed/training_scripts/bash_script_test.sh
# 
